...
function preload() {
  ...
  image_background = loadImage("sprites/background.png");

  image_player = loadImage("sprites/player.png");

  image_pipe = loadImage("sprites/pipe.png");
  image_pipe_end = image_pipe.get(0,0,16,16);

  sound_jump = loadSound("sounds/jump.mp3");
  sound_jump.amp(Settings.volume * 0.5);

  sound_pass = loadSound("sounds/pass.mp3");
