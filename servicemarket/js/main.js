...
loggedIn.registerListener(function(newValue) {
  if(newValue) {
    ...
    let registerEmailInput = UIBuilder.fromObject({type: 'input', input_type: 'email', required: true});
    let registerUsernameInput = UIBuilder.fromObject({type: 'input', input_pattern: '.{1,}'});
